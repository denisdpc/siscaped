<script>
    ...
    $: {
        if ($disponibilidadeLogistica && $disponibilidadeProdutiva) {
            $dificuldadeObtencao = matriz[$disponibilidadeProdutiva-1][3-$disponibilidadeLogistica]
        }
    }
</script>

<h2><DificuldadeObtencao /></h2>